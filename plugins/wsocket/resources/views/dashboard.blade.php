    ...
    new Vue({
        ...
        methods: {
            ...
            subscribeToChannel(channel) {
                this.pusher.subscribe('{{ \WSocket\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX }}' + channel)
            ...
            subscribeToStatistics() {
                this.pusher.subscribe('{{ \WSocket\Dashboard\DashboardLogger::LOG_CHANNEL_PREFIX }}statistics')
